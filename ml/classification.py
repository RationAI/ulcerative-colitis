...
from ml.modeling import ClassificationHead
from ml.typing import Output, TilesInput
...
class Classification(LightningModule):
    ...
    def forward(self, x: TilesInput) -> Output:
    ...
    def test_step(self, batch: TilesInput) -> None:
        ...
        for output, target, slide in zip(
            outputs, targets, metadata["slide_name"], strict=False
        ):
