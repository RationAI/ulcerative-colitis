...
from torch.nn import CrossEntropyLoss, Module, ModuleDict
...
class UlcerativeColitisModelMulticlass(LightningModule):
    def __init__(self, backbone: Module, lr: float) -> None:
        ...
        metrics: dict[str, Metric] = {
            "AUC": MulticlassAUROC(self.num_classes, average="none"),
            "accuracy": MulticlassAccuracy(self.num_classes, average="none"),
            "precision": MulticlassPrecision(self.num_classes, average="none"),
            ...
            ModuleDict(
                {
                    ...
                    "slides": AggregatedMetricCollection(
                        deepcopy(metrics),
                        aggregator,
                        prefix="validation/slides/",
                    ),
                }
            ),
        )
